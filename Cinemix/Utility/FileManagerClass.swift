...
class FileManagerClass: NSObject {
    ...
    func saveMusicToFileManager(imageData: Data) -> String? {
    ...
    func loadMusicDataFromFileManager(relativePath: String) -> Data? {
    ...
    func deleteMusicFromFileManager(relativePath: String) {
        let fileURL = localFileURL(forRelativePath: relativePath)
